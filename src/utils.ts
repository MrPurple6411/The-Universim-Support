 ...
 * @param state 
 * @param gameId The game ID to retrieve the discovery result for. Defaults to The Universim.
 ...
 * @param gamePath The path to the The Universim game directory.
 ...
 * @param gameId The game ID to retrieve the mods for. Defaults to The Universim.
 ...
 * @param gameId The game ID to reinstall the mod for. Defaults to The Universim.
